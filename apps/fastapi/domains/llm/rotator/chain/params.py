...
_DYNAMIC_QUALITY_FLOOR_STEPS: tuple[str, ...] = ("general",)
...
_NIM_REQUIRED_MSG = (
    "NVIDIA_API_KEY is not set (env or Secret). NVIDIA NIM powers the "
    "mandatory embedding + reranking models — add your NVIDIA NIM key via "
    "Secret before calling the rotator."
)
